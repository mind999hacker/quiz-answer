              ...
              return t(this, function (t) {
                switch (t.label) {
                  case 0:
                    return [
                      4,
                      fetch("https://game.quizizz.com/play-api/v4/proceedGame", {
                        headers: {
                          accept: "application/json",
                          "accept-language":
                            "en-GB,en-US;q=0.9,en;q=0.8,no;q=0.7,pl;q=0.6",
                  ...
                  case 2:
                    return (
                      (e = t.sent()),
                      console.log(e),
                      (i = e.question.structure.answer) instanceof Array &&
                      i.length > 0
                        ? (function (e) {
                            var t = r(),
                            ...
                            console.log({ notMatchingElements: a }), a.forEach(n);
                          })(i)
                        : "number" == typeof i
                        ? ((c = i),
                          (s = r()),
                          (u = Array.prototype.slice.call(s.children)),
                          (l = u
                            .filter(function (e) {
                          ...
                          u
                            ...
                            .forEach(n))
                        : e.question.structure.options
                        ? ((a = e.question.structure.options.map(function (e) {
                            return e.text;
                          })),
                          alert(a.join(" or ")),
                          console.log(a))
                        : console.log(
                            "Unable to detect automaticcly anwser type",
                            e.question
                          ),
                      [2]
                    );
